        ...
        <ul class="navbar-nav nav-grid">
            <li class="nav-item home">
                <a class="nav-link" href="#">
                    <svg height="1rem" viewBox="0 0 512 512" width="1rem" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item notif">
                <a class="nav-link" href="#">
                    <svg id="Capa_1" enable-background="new 0 0 512 512" height="1rem" viewBox="0 0 512 512"
                         width="1rem"
